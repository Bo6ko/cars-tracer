...
<form method="POST" action="?controller=cars&action=edit&car_id=<?= $car_id; ?>">
    ...
    <div>
        ...
        <select id="mark_id" name="mark_id" />
            ...
            <?php foreach( $marks as $mark) : ?>
                <option value="<?= $mark['mark_id']; ?>" <?php if ( isset($mark_id) && $mark_id == $mark['mark_id']) { echo 'select: selected'; } else { if ( $selected_car['mark_id'] == $mark['mark_id'] ) { echo 'select: selected'; } } ?>><?php echo $mark['mark_name']; ?></option>
            <?php endforeach; ?>
        </select>
        <?php 
    ...
    <div>
        ...
        <select id="model_id" name="model_id" />
            ...
            <?php foreach( $models as $model) : ?>
                <option value="<?= $model['model_id']; ?>" <?php if ( isset($model_id) && $model_id == $model['model_id']) { echo 'select: selected'; } else { if ( $selected_car['model_id'] == $model['model_id'] ) { echo 'select: selected'; } } ?>><?php echo $model['model_name']; ?></option>
            <?php endforeach; ?>
        </select>
        <?php 
    ...
    <div>
        ...
        <input type="text" id="car_register_number" name="car_register_number" value="<?php echo isset($car_register_number) ? $car_register_number : $selected_car['car_register_number'] ?>" placeholder="Register Number"/>
        <?php 
